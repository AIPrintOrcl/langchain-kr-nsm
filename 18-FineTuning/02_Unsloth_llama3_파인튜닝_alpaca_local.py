...
def main():
    ...
    # 로컬 모델과 토크나이저 로드
    model_path = "/Users/nsm/Desktop/dev/py/langchain_llama2/poet/llama-3-Korean-Bllossom-8B-Q4_K_M-GGUF/llama-3-Korean-Bllossom-8B-Q4_K_M.gguf"  # 로컬 모델 경로를 지정하세요
